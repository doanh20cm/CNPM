...
namespace Quan_li_nhan_su
{
    public partial class QLHoSoNhanVien : Form
    {
        ...
        {
            dgvHoSoNhanVien.DataSource = KetNoi.GetData("select * from HoSoNhanVien");
        ...
        {
            _index = e.RowIndex;
            if (_index > -1 && dgvHoSoNhanVien.SelectedCells.Count != 0)
            {
        ...
        {
            if (_index < 0 || dgvHoSoNhanVien.SelectedCells.Count == 0)
            {
