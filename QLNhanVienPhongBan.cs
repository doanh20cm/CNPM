	...
	public partial class QLNhanVienPhongBan : Form
	{
		...
		private void GetData()
		{
            ...
            bw.DoWork += (s1, e1) =>
            {
				...
				var tb_TenNV = KetNoi.GetData("select MaNV, HoTen from HoSoNhanVien");
				var tb_TenPhongBan = KetNoi.GetData("select MaPhongBan, TenPhongBan from PhongBan");
                e1.Result = new DataTable[3] { table, tb_TenNV, tb_TenPhongBan };
            };
            ...
            bw.RunWorkerCompleted += (s2, e2) =>
            {
                ...
                {
                    var tb_arr = (DataTable[])e2.Result;
                    dgvNhanVienPhongBan.DataSource = tb_arr[0];
